      ...
      <section className="py-16 md:py-24">
        <div className="max-w-3xl mx-auto px-4 md:px-8 lg:px-12">
          <div className="relative">
            {/* Vertical line */}
            <div className="absolute right-[19px] md:right-[23px] top-0 bottom-0 w-0.5 bg-white/30" />
              ...
              {newBusiness.steps.map((step, i) => (
                <FadeIn key={i} delay={i * 0.08}>
                  <div className="flex items-start gap-4 md:gap-6 relative">
                    {/* Step number */}
                    <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-white text-primary flex items-center justify-center font-bold text-sm md:text-base flex-shrink-0 relative z-10 shadow-md"
