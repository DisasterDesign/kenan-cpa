          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5">
            {clients.list.map((client, i) => (
              <FadeIn key={i} delay={i * 0.05}>
                <div className="flex items-center gap-4 p-5 rounded-xl bg-white shadow-md shadow-primary/10 hover:shadow-lg hover:shadow-primary/15 transition-all duration-300 group">
                  <div className="w-10 h-10 rounded-lg bg-white/15 group-hover:bg-white/25 flex items-center justify-center flex-shrink-0 transition-colors">
                    <Building2 className="w-5 h-5 text-primary/60 group-hover:text-white transition-colors" />
                  </div>
